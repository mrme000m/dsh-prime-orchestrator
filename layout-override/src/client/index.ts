...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface SlotMap {
    ...
    /**
     * The rightmost fleet column, independent of the current session: the
     * dock for a persistent system-wide surface (running agent instances,
     * background fleets). OCCUPIED by ui-prime's PrimePanel; registering here
     * replaces the column outright rather than adding to it. Absent an
     * occupant the column renders nothing.
     *
     * The occupant receives the frame's live column state (collapsed, width)
     * like the sidebar does; `ctx.layout` owns whether the column is open.
     */
...
/** Prime owner share: live column state from the frame's concession solve (the sidebar contract). */
