...
Default catalog (advisory; any Workers AI model id is routable): `@cf/zai-org/glm-5.3-flash` (1310720 ctx / 16384 out — **default delegate model**; delegations also default to the `cloudflare-workers-ai` provider with `thinking: high`), `@cf/deepseek-ai/deepseek-v4-flash-0731` (1310720 / 16384), `@cf/deepseek-ai/deepseek-v4-pro-0813` (1048576 / 16384), `@cf/openai/gpt-oss-120b` (128000 / 16384), `@cf/google/gemma-4-26b-a4b-it` (256000 / 16384), `@cf/nvidia/nemotron-3-120b-a12b` (256000 / 16384), `@cf/openai/gpt-oss-20b` (128000 / 16384), `@cf/zai-org/glm-4.7-flash` (131072 / 16384), `@cf/zai-org/glm-5.2` (262144 / 16384), `@cf/moonshotai/kimi-k2.7-code` (262144 / 16384), `@cf/moonshotai/kimi-k2.6` (262144 / 16384), and `@cf/qwen/qwen3.8-27b` (262144 / 16384). Context windows from the live Cloudflare models search API (2026-09-09); all 12 verified with a live `chat/completions` probe. `@cf/zai-org/glm-5.3` is excluded (account not provisioned).
